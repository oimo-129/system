        ...
        return this.each(function() {
            ...
            a(this).hover(function() {
                ...
                g = setTimeout(function() {
                    f.addClass(c.openedClass).find(c.dropdownEl).show();
                    $("." + c.dropdownEl).css({
                        "width": $(window).width(),
                ...
                g = setTimeout(function() {
                    e.removeClass(c.openedClass).find(c.dropdownEl).hide()
                }, c.delayTime)
            });
            a(this).bind("click", function() {
                ...
                g = setTimeout(function() {
                    e.addClass(c.openedClass).find(c.dropdownEl).show()
                }, c.delayTime)
            })
        })
    }
